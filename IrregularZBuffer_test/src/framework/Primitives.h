...
PrimitiveMesh* CreateAdjacencyTestMesh(string name = "AdjTest");
PrimitiveMesh *CreateAdjacencyTestMesh2(string name = "AdjTest2");
PrimitiveMesh *CreateAdjacencyTestMesh2Norm(string name = "AdjTest2");